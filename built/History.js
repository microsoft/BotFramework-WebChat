...
var HistoryView = (function (_super) {
    ...
    HistoryView.prototype.render = function () {
        ...
        var groupsClassName = Chat_1.classList('wc-message-groups', !this.props.format.chatTitle && 'no-header', this.props.disabled && 'disabled', this.props.format.showBrandMessage && 'brandmessage-margin');
...
exports.History = react_redux_1.connect(function (state) { return ({
    ...
    isFromMe: function (activity) { return activity.from.role === 'user' || (stateProps.user && activity.from.id === stateProps.user.id); },
...
var WrappedActivity = (function (_super) {
    ...
    WrappedActivity.prototype.render = function () {
        ...
        var messageContent = React.createElement("div", { className: 'wc-message wc-message-from-' + who, ref: function (div) { return _this.messageDiv = div; } },
        ...
        if (who === 'bot' && this.props.format && this.props.format.botIconUrl) {
            messageContent = React.createElement("div", { className: "icon-and-message" },
                React.createElement("div", { className: "bot-icon", style: { backgroundImage: "url(" + this.props.format.botIconUrl + ")" } }),
                messageContent);
        }
        ...
        }, messageContent, React.createElement("div", { className: 'wc-message-from wc-message-from-' + who }, timeLine)));
    };
