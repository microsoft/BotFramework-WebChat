...
var ShellContainer = (function (_super) {
    ...
    ShellContainer.prototype.render = function () {
        var _this = this;
        var className = Chat_1.classList('wc-console', this.props.inputText.length > 0 && 'has-text', this.props.showUploadButton && 'has-upload-button', this.props.showBrandMessage && 'brandmessage-margin');
