...
var CarouselAttachments = (function (_super) {
    ...
    CarouselAttachments.prototype.render = function () {
        ...
        return (React.createElement("ul", null, this.props.attachments.map(function (attachment, index) {
            return React.createElement("li", { className: "wc-carousel-item", key: index },
                React.createElement(Attachment_1.AttachmentView, { attachment: attachment, disabled: props.disabled, format: props.format, onCardAction: props.onCardAction, onImageLoad: props.onImageLoad }));
        })));
    };
