...
exports.format = function (state, action) {
    ...
    switch (action.type) {
        ...
        case 'Set_BotIcon_Url':
            return tslib_1.__assign({}, state, { botIconUrl: action.botIconUrl });
        case 'Set_ChatIcon_Color':
            return tslib_1.__assign({}, state, { chatIconColor: action.chatIconColor });
        case 'Set_ChatIcon_Message':
            return tslib_1.__assign({}, state, { chatIconMessage: action.chatIconMessage });
        case 'Set_BrandMessage_Status':
            return tslib_1.__assign({}, state, { showBrandMessage: action.showBrandMessage });
        case 'Set_BrandMessage':
            return tslib_1.__assign({}, state, { brandMessage: action.brandMessage });
        case 'Set_HideHeader':
            return tslib_1.__assign({}, state, { hideHeader: action.hideHeader });
        default:
            return state;
    }
};
...
exports.windowState = function (state, action) {
    if (state === void 0) { state = {
        visible: false
    }; }
    switch (action.type) {
...
exports.history = function (state, action) {
    ...
    switch (action.type) {
        case 'Set_History':
            return tslib_1.__assign({}, state, { activities: action.activities.slice() });
...
exports.createStore = function () {
    return redux_2.createStore(redux_2.combineReducers({
        ...
        shell: exports.shell,
        size: exports.size,
        windowState: exports.windowState
