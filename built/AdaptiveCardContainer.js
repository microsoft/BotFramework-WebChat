...
adaptivecards_1.AdaptiveCard.processMarkdown = function (text) {
...
var AdaptiveCardContainer = (function (_super) {
    ...
    AdaptiveCardContainer.prototype.onExecuteAction = function (action) {
        ...
        else if (action instanceof adaptivecards_1.OpenUrlAction) {
    ...
    AdaptiveCardContainer.prototype.mountAdaptiveCards = function () {
        ...
        if (errors.length === 0) {
            ...
            if (renderedCard) {
                if (this.props.disabled) {
                    var hyperlinks = renderedCard.querySelectorAll('a');
                    var inputs = renderedCard.querySelectorAll('button, input, select, textarea');
