...
const { imageSnapshotOptions } = require('../constants.json');
const createJobObservable = require('./createJobObservable');
...
module.exports = async function runPageProcessor(driver, { ignoreConsoleError = false, ignorePageError = false } = {}) {
