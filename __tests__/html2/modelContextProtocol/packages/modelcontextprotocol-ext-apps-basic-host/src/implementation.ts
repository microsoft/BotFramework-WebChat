...
/**
 * Vendored from https://github.com/modelcontextprotocol/ext-apps/blob/bcfffb6585ea4fb1e3a9da39fb8911b83399fa71/examples/basic-host/src/implementation.ts
 */
...
const SANDBOX_PROXY_BASE_URL =
  location.protocol === 'https:'
    ? 'https://friendly-space-umbrella-g565vg7v47fwg-5002.app.github.dev/sandbox.html'
