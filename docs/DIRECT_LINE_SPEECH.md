...
This guide is for using Web Chat with chat and speech functionality provided by [Direct Line Speech protocol](https://docs.microsoft.com/en-us/azure/cognitive-services/Speech-Service/direct-line-speech).

We assume you have already set up a Direct Line Speech bot and have Web Chat running on a page.
