...
- Speech-to-text: after the user click the microphone before, we fetch an authorization token, and then start recording on the microphone
...
- Text-to-speech: the synthesized text is played when the bot send the message, without any user interactions
