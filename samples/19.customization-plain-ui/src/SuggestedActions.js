...
// If the last activity is from bot and contains "suggestedActions", Web Chat will send it to us thru "suggestedActions".
...
export default connectToWebChat(({ suggestedActions }) => ({ suggestedActions }))(SuggestedActions)
