...
-  [Try out MockBot](https://microsoft.github.io/BotFramework-WebChat/06.recomposing-ui/e.intelequia)

# How to run locally

-  Fork this repository
-  Navigate to `/Your-Local-WebChat/samples/06.recomposing-ui/e.intelequia` in command line
-  Run `npm install`
-  Run `npm start`
...
npx create-react-app06.recomposing-ui/e.intelequia
cd06.recomposing-ui/e.intelequia
