...
// function mergeConfig(overridingOptions: Options & { onSuccess?: string | undefined }): Options & {
//   define: Record<string, string>;
//   esbuildPlugins: Plugin[];
//   onSuccess: string;
//   target: Target[];
...
//       NODE_ENV: env,
//       ...(npm_package_version ? { npm_package_version } : {}),
//       ...overridingOptions.env
//     },
//     dts: overridingOptions.dts ?? true,
...
//       overridingOptions.esbuildOptions?.(options, context);
//     },
//     esbuildPlugins: [
//       ...(env === 'test'
//         ? [
...
//           ]
//         : [cssPlugin]),
//       ...(overridingOptions.esbuildPlugins || [])
//     ],
//     format: overridingOptions.format ?? 'esm',
