...
export default {
  ...
  RENDER_ERROR_NOTIFICATION: 'Virhe renderöinnissä. Ole hyvä ja katso konsolia tai ota yhteys botin kehittäjään.',
  ...
  TypingIndicator: 'Näyttää kirjoitusindikaattori',
