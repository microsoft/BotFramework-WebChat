...
const thumbDislike16FilledPropsSchema = pipe(
  object({
...
type ThumbDislike16FilledProps = InferInput<typeof thumbDislike16FilledPropsSchema>;

function ThumbDislike16Filled(props: ThumbDislike16FilledProps) {
  const { className } = validateProps(thumbDislike16FilledPropsSchema, props);
...
export default memo(ThumbDislike16Filled);
export { thumbDislike16FilledPropsSchema, type ThumbDislike16FilledProps };
