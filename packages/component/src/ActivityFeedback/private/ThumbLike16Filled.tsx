...
const thumbLike16FilledPropsSchema = pipe(
  object({
...
type ThumbLike16FilledProps = InferInput<typeof thumbLike16FilledPropsSchema>;

function ThumbLike16Filled(props: ThumbLike16FilledProps) {
  const { className } = validateProps(thumbLike16FilledPropsSchema, props);
...
export default memo(ThumbLike16Filled);
export { thumbLike16FilledPropsSchema, type ThumbLike16FilledProps };
