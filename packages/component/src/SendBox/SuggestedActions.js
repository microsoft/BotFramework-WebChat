...
const SuggestedActions = ({ className, suggestedActions = [] }) => {
  ...
  const suggestedActionsContainerText = useLocalize('SuggestedActionsContainer') + (suggestedActions.length ? suggestedActionsContentText : suggestedActionsEmptyText);
