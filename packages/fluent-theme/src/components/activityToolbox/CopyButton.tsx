...
const { useLocalizer, usePonyfill } = apiHooks;
...
const CopyButton = (props: Props) => {
  ...
  useEffect(() => {
    ...
    if (copied) {
      // TODO: Can we use CSS animation here?
  ...
  return (
    <Button
      ...
      text={copyText}
    >
      {copied && <span className={classNames['activity-toolbox__copy-button__copied-text']}>{copiedText}</span>}
    </Button>
  );
};
