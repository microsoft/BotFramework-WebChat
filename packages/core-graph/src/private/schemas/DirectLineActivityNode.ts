...
const DirectLineActivityNodeSchema = pipe(
  object({
    ...
    'urn:microsoft:webchat:direct-line-activity:client-activity-id': optional(tuple([string()])),
    'urn:microsoft:webchat:direct-line-activity:id': optional(tuple([string()])),
