...
// TODO: [P*] Understand why when sending 2 messages quickly and successively, both have timestamp of "Just now".
//       The timestamp should group together as one, but it is not, until a few seconds later.

export default function clockSkewAdjustment(state = 0) {
  return state;
}
