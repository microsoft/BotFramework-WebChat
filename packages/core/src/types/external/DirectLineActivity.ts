// TODO: [P*] Rename this to WebChatActivity as this is for Web Chat.
//            A translation should be done by the chat adapter.
...
type ChannelData<SendState extends string | undefined, Type extends string> = AnyAnd<
  {
    // TODO: [P*] Rename to "webchat:attachment-sizes".
    attachmentSizes?: number[];

    // TODO: [P*] Rename to "webchat:client-activity-id".
    ...
    ? {
        // TODO: [P*] Rename to "webchat:send-state".
        state: SendState;
      }
    : {}) &
    (Type extends 'message'
      ? {
          // TODO: [P*] Rename to "webchat:message-back".
          messageBack?: {
            displayText: string;
          };

          // TODO: [P*] Rename to "webchat:post-back".
          postBack?: boolean;

          // TODO: [P*] Rename to "webchat:speak-state".
          speak?: boolean;

          // TODO: [P*] Rename to "webchat:speech-synthesis-utterance".
          speechSynthesisUtterance?: SpeechSynthesisUtterance;

          // TODO: [P*] It seems Direct Line added a new "summary" field to cater this case.
