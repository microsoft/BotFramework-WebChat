...
/***/ function(module, exports, __webpack_require__) {
	...
	var DebugView_1 = __webpack_require__(360);
	...
	var debugActivity$ = new rxjs_1.Subject();
	var state$ = function (conversation, userId, debugViewState) {
	    return activities$(conversation, userId)
	        .combineLatest(autoscroll$.distinctUntilChanged().startWith(true), debugViewState$.distinctUntilChanged().startWith(debugViewState), debugActivity$.distinctUntilChanged().startWith(undefined), console$.startWith(consoleStart), function (activities, autoscroll, debugViewState, debugActivity, console) { return ({
	...
	var getQueryParams = function () {
	    ...
	    if (params["debug"]) {
	        ...
	        if (debug === DebugViewState[DebugViewState.enabled])
	            ...
	            result.debug = DebugViewState.disabled;
	    }
	    return result;
	};
	var App = (function (_super) {
	    ...
	    App.prototype.toggleDebugView = function () {
	        var newState;
	        if (this.isDebuggerActive()) {
	            newState = DebugViewState.enabled;
	        }
	        else if (this.isDebuggingAllowed()) {
	        ...
	        if (newState !== DebugViewState.visible) {
	            debugActivity$.next(null);
	        }
	        debugViewState$.next(newState);
	    };
	    App.prototype.isDebuggerActive = function () {
	        return this.state.debugViewState === DebugViewState.visible;
	    };
	    App.prototype.isDebuggingAllowed = function () {
	        return this.state.debugViewState !== DebugViewState.disabled;
	    };
	    App.prototype.render = function () {
	        var _this = this;
	        return React.createElement("div", {className: "wc-app"}, 
	            React.createElement("div", {className: "wc-chatview-panel" + (this.isDebuggerActive() ? " wc-withdebugview" : "")}, 
	                React.createElement("div", {className: "wc-header"}, 
	                    React.createElement("span", null, "WebChat"), 
	                    React.createElement("div", {className: "wc-toggledebugview" + (this.isDebuggingAllowed() ? "" : " wc-hidden"), onClick: function () { return _this.toggleDebugView(); }}, 
	                        React.createElement("svg", {width: "20", height: "20", viewBox: "0 0 1792 1792", xmlns: "http://www.w3.org/2000/svg"}, 
	                ...
	                React.createElement(History_1.History, {activities: this.state.activities, autoscroll: this.state.autoscroll, actions: this.historyActions, userId: this.state.userId, debugActivity: this.state.debugActivity, debuggerActive: this.isDebuggerActive()}), 
	                React.createElement(Console_1.Console, __assign({actions: this.consoleActions}, this.state.console))), 
	            React.createElement("div", {className: "wc-debugview-panel" + (this.isDebuggerActive() ? "" : " wc-hidden")}, 
	                React.createElement("div", {className: "wc-header"}, 
	                    React.createElement("span", null, "Debug")
	                ), 
	                React.createElement(DebugView_1.DebugView, {activity: this.state.debugActivity})));
	    };
	    return App;
	}(React.Component));
	    ...
	    History.prototype.render = function () {
	        ...
	        return (React.createElement("div", {className: "wc-message-groups", ref: function (ref) { return _this.scrollMe = ref; }, onScroll: function (e) { return _this.props.actions.setAutoscroll(e.target.scrollTop + e.target.offsetHeight >= e.target.scrollHeight); }}, 
	            React.createElement("div", {className: "wc-message-group"}, this.props.activities
	                ...
	                var clickable = _this.props.debuggerActive;
	                var selected = activity === _this.props.debugActivity;
	                ...
	                return (React.createElement("div", {className: 'wc-message wc-message-from-' + (activity.from.id === 'user' ? 'me' : 'bot')}, 
	                    React.createElement("div", {className: contentClassName, onClick: clickable ? function (e) { _this.props.actions.onMessageClicked(activity, e); } : function () { }}, 
	                        ...
	                        React.createElement(HistoryMessage_1.HistoryMessage, {activity: activity, actions: _this.props.actions, clickable: _this.props.debuggerActive, selected: activity === _this.props.debugActivity})), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var FormattedJSON_1 = __webpack_require__(361);
