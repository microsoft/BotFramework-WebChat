...
/***/ function(module, exports, __webpack_require__) {
	...
	var History_tsx_1 = __webpack_require__(351);
	var Console_tsx_1 = __webpack_require__(356);
	var guid = function () {
	...
	var App = (function (_super) {
	    ...
	    App.prototype.render = function () {
	        return React.createElement("div", {className: "wc-app"}, 
	            ...
	            React.createElement(History_tsx_1.History, {messagegroups: this.state.messagegroups, autoscroll: this.state.autoscroll, actions: this.historyActions}), 
	            React.createElement(Console_tsx_1.Console, __assign({actions: this.consoleActions}, this.state.console)));
	    };
	    return App;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var Timestamp_tsx_1 = __webpack_require__(352);
	var HistoryMessage_tsx_1 = __webpack_require__(353);
	    ...
	    History.prototype.render = function () {
	        ...
	        return (React.createElement("div", {className: "wc-message-groups", ref: function (ref) { return _this.scrollme = ref; }, onScroll: function (e) { return _this.props.actions.setAutoscroll(e.target.scrollTop + e.target.offsetHeight >= e.target.scrollHeight); }}, this.props.messagegroups.map(function (messagegroup) {
	            return React.createElement("div", {className: "wc-message-group"}, 
	                React.createElement(Timestamp_tsx_1.Timestamp, {timestamp: messagegroup.timestamp}), 
	                messagegroup.messages.map(function (message) { return React.createElement(HistoryMessage_tsx_1.HistoryMessage, {message: message, actions: _this.props.actions}); }));
	        })));
	    };
	    return History;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var React = __webpack_require__(2);
	var Attachment_tsx_1 = __webpack_require__(354);
	var Carousel_tsx_1 = __webpack_require__(355);
	...
	exports.HistoryMessage = function (props) {
	    ...
	    if (props.message.channelData) {
	        ...
	        if (attachmentLayout === 'carousel' && props.message.channelData.attachments.length > 1) {
	            inside = React.createElement(Carousel_tsx_1.Carousel, {attachments: props.message.channelData.attachments, actions: props.actions});
	        }
	        else {
	            inside = React.createElement(Attachment_tsx_1.Attachment, {attachment: props.message.channelData.attachments[0], actions: props.actions});
	        }
	    }
	    else
	...
	var Carousel = (function (_super) {
	    ...
	    Carousel.prototype.render = function () {
	        ...
	        var items = this.props.attachments.map(function (attachment) { return React.createElement("li", null, 
	            React.createElement(Attachment_tsx_1.Attachment, {attachment: attachment, actions: _this.props.actions})
	        ); });
