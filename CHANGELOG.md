...
-  Updated comment to include GitHub issue # in `postActivity()` method of `DirectLineSpeech` class, by [@stevkan](https://github.com/stevkan) in PR [#XXXX](https://github.com/microsoft/BotFramework-WebChat/pull/XXXX)
