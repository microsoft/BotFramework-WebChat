...
- `component`: Added `suggestedAction` images per issue [#1739](https://github.com/Microsoft/BotFramework-WebChat/issues/1739), by [@tdurnford](https://github.com/tdurnford), in PR [#XXX](https://github.com/Microsoft/BotFramework-WebChat/pull/XXX)
- 
### Changed
