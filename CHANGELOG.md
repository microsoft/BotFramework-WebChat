...
-  Fixes [#5047](https://github.com/microsoft/BotFramework-WebChat/issues/5047). Added condition for `FocusRedirector` in PR [#5206](https://github.com/microsoft/BotFramework-WebChat/pull/5206), by [@amirmursal](https://github.com/amirmursal)
