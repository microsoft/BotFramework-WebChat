...
-  Added `timestampConfig` option to the default style options, by [@tdurnford](https://github.com/tdurnford), in PR [#XXX](https://github.com/microsoft/BotFramework-WebChat/pull/XXX)
