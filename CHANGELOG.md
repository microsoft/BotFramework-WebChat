...
- `component`: [Password input activity](https://microsoft.github.io/BotFramework-WebChat/10.b.customization-password-input/), in [#XXX](https://github.com/Microsoft/BotFramework-WebChat/pull/XXX)
