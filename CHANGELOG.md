...
-  Resolves [#2996](https://github.com/microsoft/BotFramework-WebChat/issues/2996). Up and down arrow keys will now scroll the transcript, by [@compulim](https://github.com/compulim) in PR [#3703](https://github.com/microsoft/BotFramework-WebChat/pull/3703)
