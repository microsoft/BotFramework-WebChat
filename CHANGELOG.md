...
-  Updated comment to include GitHub issue # in `postActivity()` method of `DirectLineSpeech` class, by [@stevkan](https://github.com/stevkan) in PR [#3542](https://github.com/microsoft/BotFramework-WebChat/pull/3542)
