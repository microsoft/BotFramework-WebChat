...
-  Make thumbnails for uploading attachments and store it in `channelData.attachmentThumbnails`, by [@compulim](https://github.com/compulim), in PR [#XXX](https://github.com/microsoft/BotFramework-WebChat/pull/XXX)
