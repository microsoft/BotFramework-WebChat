...
- Cleanup: `dependencies` and `devDependencies` in both `package.json` and `test/package.json` is much cleaner and independent of each other, in [PR #XXX](https://github.com/Microsoft/BotFramework-WebChat/pull/XXX)
