...
-  Moved the typing indicator to the send box and removed the typing indicator logic from the sagas, by [@tdunrford](https://github.com/tdurnford), in PR [#23XX](https://github.com/microsoft/BotFramework-WebChat/pull/23XX)
