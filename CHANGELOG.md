...
-  Added `focusSendBoxInput()` method to `ComposerRef` for programmatically focusing the send box input element, by [@marclundgren](https://github.com/marclundgren), in PR [#5512](https://github.com/microsoft/BotFramework-WebChat/pull/5512)
