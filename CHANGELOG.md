...
- Added richCardsWrapTitle to defaultStyleOptions, by [@tdurnford](https://github.com/tdurnford), in PR [#21XX](https://github.com/Microsoft/BotFramework-WebChat/pull/21XX)
