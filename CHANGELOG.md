...
- Added hideUploadButton boolean to DropZone rendering logic inside SendBox.tsx to prevent file upload when true, in PR [#5508](https://github.com/microsoft/BotFramework-WebChat/pull/5508), by [@JamesNewbyAtMicrosoft](https://github.com/JamesNewbyAtMicrosoft)
