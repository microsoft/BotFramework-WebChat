...
- `component`: [Hybrid speech engine](https://microsoft.github.io/BotFramework-WebChat/06.f.hybrid-speech/), in [#XXX](https://github.com/Microsoft/BotFramework-WebChat/pull/XXX)
