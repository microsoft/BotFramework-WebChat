...
- Bumped dependencies, by [@compulim](https://github.com/compulim) in PR [#5768](https://github.com/microsoft/BotFramework-WebChat/pull/5768)
   ...
   - Development dependencies
      ...
      - [`@fluentui/tokens@1.0.0alpha.23"`](https://npmjs.com/package/@fluentui/tokens/v/1.0.0-alpha)
