...
-  Fixes [#4721](https://github.com/microsoft/BotFramework-WebChat/issues/4721). Adaptive Cards `TextBlock` heading elements should start at level 2, by [@compulim](https://github.com/compulim), in PR [#4747](https://github.com/microsoft/BotFramework-WebChat/issues/4747)
