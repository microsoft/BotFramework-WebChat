...
| [`06.g.select-voice`](https://github.com/microsoft/BotFramework-WebChat/tree/master/samples/06.g.select-voice)                                                                                                                     | Demonstrates how to select speech synthesis voice based on activity.                                                                                                                                                                | [Hybrid Speech Demo](https://microsoft.github.io/BotFramework-WebChat/06.g.select-voice)                                                                |
