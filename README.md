...
- One of our team's favorite things about v4 of Web Chat is the ability to add customization **without the need to fork Web Chat**. Although this creates additional overhead for v3 users that forked Web Chat, we will do our best to support customers making the bump. Please use the following suggestions:
  ...
  1. Make sure to check out the rest of this `README` for more information.
...
| `attachmentMiddleware`     | A chain of middleware that allows the developer to add new DOM on attachments. The signature is `options => next => card => next(card)` .                                                                                                                                                                                                 |
| `attachmentRenderer`       | The 'flattened' version of `attachmentMiddleware`.                                                                         |
| `directLine`               | Pass in the DirectLine object with DirectLine token.                                                                                                                                                                                                                                                                                      |
| `disabled`                 | For disabling the UI (i.e. for presentation mode) of Web Chat.                                                                                                                                                                                                                                                                            |
| `grammars`                 |                                                                                                                                                                                                                                                                                                                                           |
...
| `scrollToBottom`           |                                                                                                                                                                                                                                                                                                                                           |
| `scrollToEnd`              |                                                                                                                                                                                                                                                                                                                                           |
| `sendTypingIndicator`      | Display a typing indicator from the user when typing.                                                                                                                                                                                                                                                                                     |
| `store`                    | Pass in a custom store, e.g. for adding programmatic activity to the bot.                                                                                                                                                                                                                                                                 |
...
| `userID`                   |                                                                                                                                                                                                                                                                                                                                           |
| `username`                 |                                                                                                                                                                                                                                                                                                                                           |
| `webSpeechPonyFillFactory` | Pass in the Web Speech object for text-to-speech and speech-to-text.                                                                                                                                                                                                                                                                      |
