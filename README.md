...
| [`06.f.hybrid-speech`](https://github.com/Microsoft/BotFramework-WebChat/tree/master/06.f.hybrid-speech)                                                                                   | Demonstrates how to both browser-based Web Speech API for speech-to-text, and Cognitive Services Speech Services API for text-to-speech.                                                                                            | [Demo](https://microsoft.github.io/BotFramework-WebChat/06.f.hybrid-speech)                                          |
