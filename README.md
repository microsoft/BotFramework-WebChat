...
```
The field above are the fields required to provide chat history to webchat.  Keep in mind you will probably want to store more information.  Specifically you will most likely want a timestamp on each activity to order them in the correct chronological order.  It is suggested to consult the [Activity](https://docs.microsoft.com/en-us/bot-framework/rest-api/bot-framework-rest-connector-api-reference#activity-object) documentation when storing activities for the purnpose of displaying chat history.
