        ...
        return (
            <div className={className}>
                ...
                <div className="wc-textbox">
                    <input type="text" ref={ref => this.textInput = ref } autoFocus value={ state.history.input } onChange={ e => this.onChangeInput((e.target as any).value) } onKeyPress = { e => this.onKeyPress(e) } placeholder={ state.format.strings.placeholder } />
                </div>
