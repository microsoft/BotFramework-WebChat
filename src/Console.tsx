...
export const Console = (props: {
    ...
    <div id="outgoingFrame" className="wc-console">
        ...
        <input type="text" autoFocus id="outgoing" value={ props.text } onChange={ e => props.actions.updateMessage(e.target.value) } onKeyPress = { e => e.key == 'Enter' ? props.actions.sendMessage() : null } disabled={ !props.enableSend } placeholder="Type your message..." />
