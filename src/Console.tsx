...
export const Console = (props: {
    ...
    <div id="outgoingFrame" className="wc-console">
        ...
        <input type="text" id="outgoing" value={ props.text } onChange={ e => props.actions.updateMessage(e.target.value) } disabled={ !props.enableSend } placeholder="Type your message..." />
