...
export const Console = (props: {
    ...
    <div className="wc-console">
        <label className="wc-upload">
            <input type="file" accept="image/*" multiple onChange={ e => props.actions.sendFile((e.target as any).files) } />
        ...
        <div className="wc-textbox">
            <input type="text" autoFocus value={ props.text } onChange={ e => props.actions.updateMessage((e.target as any).value) } onKeyPress = { e => e.key == 'Enter' ? props.actions.sendMessage() : null } disabled={ !props.enableSend } placeholder="Type your message..." />
        </div>
